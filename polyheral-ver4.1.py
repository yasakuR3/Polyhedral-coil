...
def main():
    ...
    ko1 = 1
    for i in range(0, 5):
        triangles.append(((1, 2, ko1), (1, 2, ko1-1), (1, 3, ko1)))
        triangles.append(((1, 2, ko1), (1, 3, (ko1+1)%10), (1, 3, ko1)))
        triangles.append(((1, 4, ko1), (1, 3, (ko1+1)%10), (1, 3, ko1)))
        triangles.append(((1, 4, ko1), (1, 3, (ko1+1)%10), (1, 4, (ko1+1)%10)))
    ...
    vb1 = 1
    for i in range(0, 5):
        triangles.append(((1, 3, vb1), (1, 3, vb1-1), (1, 4, vb1-1)))
        triangles.append(((1, 3, vb1), (1, 4, vb1), (1, 4, vb1-1)))
        triangles.append(((1, 5, vb1), (1, 4, vb1), (1, 4, vb1-1)))
        triangles.append(((1, 5, vb1), (1, 5, vb1-1), (1, 4, vb1-1)))
    ...
    fg1 = 1
    for i in range(0, 5):
        triangles.append(((1, 5, fg1), (1, 4, fg1), (1, 4, (fg1+1)%10)))
        triangles.append(((1, 5, fg1), (1, 5, (fg1+1)%10), (1, 4, (fg1+1)%10)))
        triangles.append(((1, 5, fg1), (1, 5, (fg1+1)%10), (1, 6, (i+1)%5)))
    ...
    sd1 = 1
    for i in range(0, 5):
        triangles.append(((1, 5, jk1), (1, 5, jk1-1), (1, 6, i)))
        triangles.append(((1, 5, jk1), (1, 6, sd1%5), (1, 6, i)))
        triangles.append(((1, 7, sd1%5), (1, 6, sd1%5), (1, 6, i)))
        triangles.append(((1, 7, sd1%5), (1, 7, i), (1, 6, i)))
