   ...
   # x5, y5, z5 = y_θ(x5, y5,z5, kei)
    ...
    for v in range(0, 2):
        for i in range(0, 6):
            ...
            hesa[1, v, i, 2] = link[v, i, 2] #* np.sin(np.radians(kei)) + link[v, i, 2] * np.cos(np.radians(kei))
    ...
    for i in range(0, 6):
        ...
        triangle_index_list_hesa.append(((1, 0, i), (1, 0, (i+1)%6), (1, 1, i)))
        triangle_index_list_hesa.append(((1, 0, (i+1)%6), (1, 1, (i+1)%6), (1, 1, i)))

        triangle_index_list_hesa.append(((0, 0, i), (0, 0, (i+1)%6), (1, 0, i)))
        triangle_index_list_hesa.append(((1, 0, (i+1)%6), (0, 0, (i+1)%6), (1, 0, i)))
